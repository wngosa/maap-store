class Api::V1::ElectronicPharmacyStockRecordsController < ApplicationController
  def create
    electronic_pharmacy_stock_record = build_electronic_pharmacy_stock_record

    if electronic_pharmacy_stock_record.save
      AnonymizeElectronicPharmacyStockRecordWorker.perform_async(electronic_pharmacy_stock_record.id)
