  ...
  module V1
    class LabRecordImportsController < ApplicationController
      ...
      def build_lab_record_import
        ...
        LabRecord.import!(JSON[params[:lab_records_attributes]].map do |lab_record_attributes|
          lab_record = LabRecord.new(lab_record_attributes, site: lab_record_import.site)
