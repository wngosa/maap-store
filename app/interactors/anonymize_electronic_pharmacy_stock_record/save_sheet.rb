module AnonymizeElectronicPharmacyStockRecord
  class SaveSheet
    ...
    def call # rubocop:disable Metrics/AbcSize
      file_id = (context.electronic_pharmacy_stock_record.site_id || 'unknown-site').to_s
      filename = "#{file_id}-#{context.electronic_pharmacy_stock_record.id}"

      save_file!
      context.electronic_pharmacy_stock_record.sheet_file.attach(
