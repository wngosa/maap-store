...
RSpec.describe Patient, type: :model do
  describe "patient_id_hash_for" do
    ...
    it "doesn't create a patient id hash if there is an existing entry for given patient_id" do
      ...
      existing_pid_hash = create(:patient_id_hash, patient_id: existing_patient_id, hashed_value: existing_hashed_value, site: site) 
      previous_count = PatientIdHash.count

      hashed_value = Patient.patient_id_hash_for(existing_patient_id, site.id)
